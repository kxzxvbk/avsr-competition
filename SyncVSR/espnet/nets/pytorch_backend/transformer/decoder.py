...
from SyncVSR.espnet.nets.pytorch_backend.transformer.attention import MultiHeadedAttention
from SyncVSR.espnet.nets.pytorch_backend.transformer.decoder_layer import DecoderLayer
