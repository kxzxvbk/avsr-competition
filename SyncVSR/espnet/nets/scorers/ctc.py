...
from SyncVSR.espnet.nets.ctc_prefix_score import CTCPrefixScore, CTCPrefixScoreTH
from SyncVSR.espnet.nets.scorer_interface import BatchPartialScorerInterface
